...
class _ExprEncoder(_Encoder[List[Operation]]):
    def encode(self, value: List[Operation], byteorder: Literal["big", "little"], ptr_size: int) -> bytes:
        ...
...
class Instruction:
    ...
    """
    @abc.abstractmethod
    def assembly_string(self, byteorder: Literal["big", "little"], ptr_size: int) -> str:
        ...
    
    @abc.abstractmethod
    def gtirb_encoding(self, byteorder: Literal["big", "little"], ptr_size: int) -> CFIDirectiveType:
        ...
...
class _SimpleInstruction(Instruction):
    _registered_opcodes: ClassVar[Set[CallFrameInstructions]] = ...
    _registered_directives: ClassVar[Set[str]] = ...
    _directive: ClassVar[str]
    _opcode: ClassVar[Optional[CallFrameInstructions]]
    _encoding: ClassVar[List[_Encoder]]
    def __init_subclass__(cls, *, directive: str, opcode: Optional[CallFrameInstructions], encoding: List[_Encoder]): # -> None:
        ...
...
class InstDefCFA(_SimpleInstruction, directive=".cfi_def_cfa", opcode=CallFrameInstructions.def_cfa, encoding=[_ULEB128Encoder(), _ULEB128Encoder()]):
    """
...
class InstDefCFASF(_SimpleInstruction, directive=".cfi_escape", opcode=CallFrameInstructions.def_cfa_sf, encoding=[_ULEB128Encoder(), _SLEB128Encoder()]):
    """
...
class InstDefCFARegister(_SimpleInstruction, directive=".cfi_def_cfa_register", opcode=CallFrameInstructions.def_cfa_register, encoding=[_ULEB128Encoder()]):
    """
...
class InstDefCFAOffset(_SimpleInstruction, directive=".cfi_def_cfa_offset", opcode=CallFrameInstructions.def_cfa_offset, encoding=[_ULEB128Encoder()]):
    """
...
class InstDefCFAOffsetSF(_SimpleInstruction, directive=".cfi_escape", opcode=CallFrameInstructions.def_cfa_expression, encoding=[_ExprEncoder()]):
    """
...
class InstUndefined(_SimpleInstruction, directive=".cfi_undefined", opcode=CallFrameInstructions.undefined, encoding=[_ULEB128Encoder()]):
    """
...
class InstSameValue(_SimpleInstruction, directive=".cfi_same_value", opcode=CallFrameInstructions.same_value, encoding=[_ULEB128Encoder()]):
    """
...
class InstOffset(_SimpleInstruction, directive=".cfi_offset", opcode=CallFrameInstructions.offset, encoding=[_Low6Bits, _ULEB128Encoder()]):
    """
...
class InstOffsetExtended(_SimpleInstruction, directive=".cfi_escape", opcode=CallFrameInstructions.offset_extended, encoding=[_ULEB128Encoder(), _ULEB128Encoder()]):
    """
...
class InstOffsetExtendedSF(_SimpleInstruction, directive=".cfi_escape", opcode=CallFrameInstructions.offset_extended_sf, encoding=[_ULEB128Encoder(), _SLEB128Encoder()]):
    """
...
class InstValOffset(_SimpleInstruction, directive=".cfi_val_offset", opcode=CallFrameInstructions.val_offset, encoding=[_ULEB128Encoder(), _ULEB128Encoder()]):
    """
...
class InstValOffsetSF(_SimpleInstruction, directive=".cfi_escape", opcode=CallFrameInstructions.val_offset_sf, encoding=[_ULEB128Encoder(), _SLEB128Encoder()]):
    """
...
class InstRegister(_SimpleInstruction, directive=".cfi_register", opcode=CallFrameInstructions.register, encoding=[_ULEB128Encoder(), _SLEB128Encoder()]):
    """
...
class InstExpression(_SimpleInstruction, directive=".cfi_escape", opcode=CallFrameInstructions.expression, encoding=[_ULEB128Encoder(), _ExprEncoder()]):
    """
...
class InstValExpression(_SimpleInstruction, directive=".cfi_escape", opcode=CallFrameInstructions.val_expression, encoding=[_ULEB128Encoder(), _ExprEncoder()]):
    """
...
class InstRestore(_SimpleInstruction, directive=".cfi_restore", opcode=CallFrameInstructions.restore, encoding=[_Low6Bits]):
    """
...
class InstRestoreExtended(_SimpleInstruction, directive=".cfi_escape", opcode=CallFrameInstructions.restore_extended, encoding=[_ULEB128Encoder()]):
    """
...
class InstRememberState(_SimpleInstruction, directive=".cfi_remember_state", opcode=CallFrameInstructions.remember_state, encoding=[]):
    """
...
class InstRestoreState(_SimpleInstruction, directive=".cfi_restore_state", opcode=CallFrameInstructions.restore_state, encoding=[]):
    """
...
class InstNop(_SimpleInstruction, directive=".cfi_escape", opcode=CallFrameInstructions.nop, encoding=[]):
    """
...
class InstRelOffset(_SimpleInstruction, directive=".cfi_rel_offset", opcode=None, encoding=[]):
    """
...
class InstAdjustCFAOffset(_SimpleInstruction, directive=".cfi_adjust_cfa_offset", opcode=None, encoding=[]):
    """
